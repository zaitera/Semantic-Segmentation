...
#
# Usage:
#   bash ./download_and_convert_voc2007.sh
#
# The folder structure is assumed to be:
#  + datasets
#     - build_data.py
#     - build_voc2012_data.py
#     - download_and_convert_voc2007.sh
...
# Root path for PASCAL VOC 2007 dataset.
PASCAL_ROOT="${WORK_DIR}/VOCdevkit/VOC2007"
...
echo "Converting PASCAL VOC 2007 dataset..."
python ./build_voc2007_data.py \
